...
def train(args):
    ...
    if args.pretrained:
        ...
        model.gfn_init_ = types.MethodType(LETTER.gfn_init_, model)
        ...
        model.set_hyper =types.MethodType(LETTER.set_hyper, model)
    ...
    model.gfn_init_(prefix_allowed_tokens, args)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='LLMRec-GFN')
    parser = parse_gfn_args(parser)
