...
def parse_args():
    ...
    parser.add_argument("--root_path", type=str, default="./data", help="Root file path.")
    parser.add_argument("--data", type=str, default='fashion', help="")
    ...
    parser.add_argument('--num_emb_list', type=int, nargs='+', default=[256,256,256,256,256,256], help='emb num of every vq')
...
if __name__ == '__main__':
    ...
    args = parse_args()
    args.data_path =  os.path.join(args.root_path,args.data+f'/{args.data}.emb-llama-td-pca.npy')
    args.ckpt_dir = os.path.join(f'{args.root_path}/RQ-VAE-checkpoint',args.data)
    ...
    if args.cf_emb!='0':
        ...
        print("CF embedding loaded!!!")
    else:
        cf_emb = 0
        print("No CF Embedding")
    """build dataset"""
